...
public abstract class BlockMidrockBrick_slab extends BlockSlab {

	public BlockMidrockBrick_slab(String unlocalizedName) {
		super(Material.ROCK);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.midrockbrick_slab_half);
	}
