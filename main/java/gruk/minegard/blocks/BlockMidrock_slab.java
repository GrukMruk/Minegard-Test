...
public abstract class BlockMidrock_slab extends BlockSlab {

	public BlockMidrock_slab(String unlocalizedName) {
		super(Material.ROCK);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.midrock_slab_half);
	}
